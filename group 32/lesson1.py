...
#name არის ცვლადი 
# = არის ცვლადისთის მნიშვნელობის მიმნჭებელი სიმბოლო
 #"nika" არის ცვლადისთვის მნიშნელონა
...
name = "nikusha" #ეს არის str (string) ტიპის ცვლადი
age = 14 #ეს არის int (integer) მთელი რიცხვი
height = 171.5 #ეს არის float ტიპის ცვლადი (ათწილადი)
